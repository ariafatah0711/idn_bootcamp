...
- [./log](https://github.com/ariafatah0711/idn_bootcamp/tree/main/task/week_9/2_fine_tunning_wazuh/log)
...
- buat container terlebih dahulu dengan ketentuan seperti ini: image=wazuh/wazuh-manager, dan port forwardnya seperti dibawah
...
```bash
nano /var/ossec/ruleset/decoders/0585-openstack-nova.xml # lalu masukan rules
